...
export const CHANNEL_ID = process.env.CHANNEL_ID || "1062772832658010213";
...
export const PLAYER_NAMES = [
  ...
  },
  {
    ...
    puuid:
      "Olucnaj87N9veLIAEl6oPCOkK6Z471dlab2-mPIqLkOERBLAyqfxvyasLfgf-lsYuItxROZC3X9S-Q",
  ...
  },
  {
    ...
    puuid:
      "PNiQxL2ewpDF62Yrq9TFOinNqwf3Gk9W4iwNPS9DlBhcpcHQ32JlmBaV6jTcZWR2PC_Hvbrf7Ehzuw",
  ...
  },
  {
    ...
    userName: "Fidel 69",
    puuid:
      "NHjGLq1Sc-hDMVBv1jpaYu3lDYFiKtgmE7KUOhoT_UikjC6Be7acXy2bHMtV7bLlUSH8jE1ReIzX_g",
...
export interface LeagueRanking { [key: string]: number; }

export const LEAGUE_RANKS: LeagueRanking = {
  Iron: 0,
  Bronze: 1,
  Silver: 2,
  Gold: 3,
...
export const LEAGUE_TIERS: LeagueRanking = {
  I: 4,
  II: 3,
  III: 2,
  IV: 1,
